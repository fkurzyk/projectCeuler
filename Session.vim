...
silent! normal! zE
let s:l = 25 - ((5 * winheight(0) + 12) / 24)
...
wincmd w
argglobal
if bufexists("fiku.h") | buffer fiku.h | else | edit fiku.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("fiku_test.c") | buffer fiku_test.c | else | edit fiku_test.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("3/3.c") | buffer 3/3.c | else | edit 3/3.c | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((17 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
